...
class Ontology:
    def __init__(self, title="", label="", description="", creator="", contributor="", rights="", subject="",
                 license="", version="", seeAlso=""):
        self.title = title
        self.label = label
...
class Property:
    def __init__(self, class_id, prop_id, label="", description="", prop_type=["qualitative", "string"], synonyms="",
                 UnitOfMeasurementName=None, UnitOfMeasurementSymbol=None):
        ...
        self.synonyms = synonyms
        self.UnitOfMeasurementName = UnitOfMeasurementName
        self.UnitOfMeasurementSymbol = UnitOfMeasurementSymbol
